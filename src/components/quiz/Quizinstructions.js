...
import options from '../../assets/img/1.png';
import answer from '../../assets/img/2.png';
import fifty from '../../assets/img/3.png';
import hints from '../../assets/img/4.png';

const QuizInstructions = () => (
    <Fragment>
        <Helmet><title>Your Quiz - Instructions</title></Helmet>
        <div className="instructions container">
            ...
            <ul className="browser-default" id="main-list">
                ...
                <li>
                    ...
                    <img src={fifty} alt="Fifty chance example"/>
                </li>
                <li>
                    ...
                    <img src={hints} alt="Hints use example"/>
                </li>
